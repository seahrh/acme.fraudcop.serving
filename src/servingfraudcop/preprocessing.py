__all__ = ["preprocess", "Example", "Features"]
...
TYPE_ENCODING = _as_dict(_conf["production"]["type_encoding"])
AMOUNT_STATS = _as_dict(_conf["production"]["amount_stats"])
CARD_AGE_STATS = _as_dict(_conf["production"]["card_age_stats"])
